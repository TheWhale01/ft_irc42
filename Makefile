...
SRCS= $(addprefix $(SRC_DIR), main.cpp Server.cpp Channel.cpp Client.cpp utils.cpp \
	...
	cmd/ping.cpp cmd/whois.cpp cmd/invite.cpp \
	exceptions/exception.cpp exceptions/InviteOnlyChanException.cpp \
	exceptions/UnknownModeException.cpp exceptions/UserOnChannelException.cpp \
